...
def line_wrap_content(
    ...
    for interval in context_intervals:
        ...
        for i, line in enumerate(lines):
            ...
            block_lines.append(line_format.format(line_number=i + 1, line=line))
...
def get_repo_structure(instance_id: str, repo_name, base_commit, playground, structure, args, **kwargs):
    ...
    d = get_project_structure_from_scratch(
        repo_name, base_commit, instance_id, playground, structure, args, **kwargs
    )
    repo_structure = d["structure"]
